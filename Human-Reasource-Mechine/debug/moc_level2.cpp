...
const QMetaObject Level2::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Level2.data,
      qt_meta_data_Level2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Level2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Level2.stringdata0))
        return static_cast<void*>(const_cast< Level2*>(this));
